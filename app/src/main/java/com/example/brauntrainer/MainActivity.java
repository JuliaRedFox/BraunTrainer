package com.example.brauntrainer;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        option.add(textViewOption0);
        option.add(textViewOption1);
        option.add(textViewOption2);
        option.add(textViewOption3);
        ...
        CountDownTimer timer = new CountDownTimer(20000, 100) {
            ...
            public void onFinish() {
                ...
                if (countOfRightAnswers >= maxResult){
